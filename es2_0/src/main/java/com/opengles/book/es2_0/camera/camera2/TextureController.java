...
public class TextureController implements GLSurfaceView.Renderer {
    ...
    private Camera2Renderer.CallBack mFrameCallback;                       //回调
    ...
    public void setFrameCallback(int width,int height,Camera2Renderer.CallBack frameCallback){
    ...
    private void frameCallback(){
        ...
        mFrameCallback.onFrame(outPutBuffer[indexOutput].array(),frameCallbackWidth,frameCallbackHeight);
    }
