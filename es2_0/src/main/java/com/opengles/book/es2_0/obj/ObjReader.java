...
import com.opengles.book.es2_0.obj.bean.MtlInfo;
 ...
 * desc:  重点： 本工具类是 从3D模型文件里面 取出需要的数据（顶点，法线数据等）
 */
public class ObjReader {

    public static final String hat = "3dres/hat.obj"; // 帽子3D模型
    public static final String pikachu = "assets/3dres/pikachu.obj"; // 皮卡丘3D模型
